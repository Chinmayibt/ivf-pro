...
const KnowledgeLayerCard = ({ result, loading }) => {
  if (loading) return <div className="result-card">Loading knowledge layer...</div>;
  if (!result) return <div className="result-card">Knowledge layer will appear after prediction.</div>;
